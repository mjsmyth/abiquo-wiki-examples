...
|Property | Default | Description | Default text file |
|:-----|:-----|:------|:-----|
|existing | yes | Update existing pages listed (i.e. pages with no status string) | 0001  |
|modifier | no | Update pages modified by users that are not the script user  | 0001  |
|alternative | yes | Update pages with an alternative page number version, e.g. 0002 | alternate  |
|duplicate | no | Update pages with a duplicate file with the file text of the other version e.g. XXXX.0001.txt changes to xxxx.0001.txt and vice versa | duplicate  |
|custom | no | Update pages with a valid custom file name, e.g. myfile.txt | custom  |
|invalid | no | Update pages with an invalid file name, e.g. text with spaces | 0001  |
